-- =====================================================
-- MIGRACIÓN CORREGIDA PARA INTEGRACIÓN CON MOODLE
-- =====================================================
...
-- =====================================================
-- AGREGAR CAMPOS A LA TABLA EVENTOS EXISTENTE
-- =====================================================

-- Verificar si la columna moodle_assignment_id existe antes de agregarla
SET @sql = (SELECT IF(
  (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
   WHERE TABLE_SCHEMA = DATABASE() 
   AND TABLE_NAME = 'eventos' 
   AND COLUMN_NAME = 'moodle_assignment_id') = 0,
...
-- Verificar si la columna moodle_course_id existe antes de agregarla
SET @sql = (SELECT IF(
  (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
   WHERE TABLE_SCHEMA = DATABASE() 
   AND TABLE_NAME = 'eventos' 
   AND COLUMN_NAME = 'moodle_course_id') = 0,
...
SET @sql = (SELECT IF(
  (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
   WHERE TABLE_SCHEMA = DATABASE() 
   AND TABLE_NAME = 'eventos' 
   AND INDEX_NAME = 'moodle_assignment_id') = 0,
...
SET @sql = (SELECT IF(
  (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
   WHERE TABLE_SCHEMA = DATABASE() 
   AND TABLE_NAME = 'eventos' 
   AND INDEX_NAME = 'moodle_course_id') = 0,
...
SELECT 'Tablas de Moodle creadas exitosamente' as status;
